...
attitude_quaternion_normed_BI = attitude_quaternion_BI / norm(attitude_quaternion_BI);
...
% Magnetics
magnetic_field_B__T = smu.unitQuat.att.transformVector(attitude_quaternion_normed_BI, magnetic_field_I__T);
