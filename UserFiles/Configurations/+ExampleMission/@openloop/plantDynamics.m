...
attitude_quaternion_normed_BI =  PlantStates.RigidBody.attitude_quaternion_BI / norm(PlantStates.RigidBody.attitude_quaternion_BI);
...
control_surface_angles__rad = ActuatorsOutputs.ControlSurfaces.control_surface_angles__rad;

%% Forces and Torques

% Gravity
gravitational_force_I__N = zeros(3,1);

% Aerodynamics
[aerodynamic_force_B__N, aerodynamic_torque_B__Nm] ...
    = SimplifiedVleoAerodynamics.execute(attitude_quaternion_normed_BI, ...
                                            ...
                                            control_surface_angles__rad, ...
                                            ParametersPlant.SimplifiedVleoAerodynamics);
aerodynamic_force_I__N = smu.unitQuat.att.transformVector(smu.unitQuat.invert(attitude_quaternion_normed_BI), aerodynamic_force_B__N);

% Magnetics
magnetic_torque_B__N_m = zeros(3,1);

% Reaction Wheel Array
reaction_torque_B__N_m = zeros(3,1);
gyroscopic_torque_B__N_m = zeros(3,1);
rw_angular_velocities_derivative__rad_per_s2 = zeros(3,1);
